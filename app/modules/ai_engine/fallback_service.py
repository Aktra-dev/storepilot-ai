            ...
            if stockout.risk_level in _RISK_TO_SEVERITY:
                findings.append(
                    AIFinding(
                        ...
                        title=f"Stockout risk for product {risk.product_id or 'unknown'}",
                        description=(
            ...
            if expiry.risk_level in _RISK_TO_SEVERITY:
                findings.append(
                    AIFinding(
                        ...
                        title=f"Expiry risk for product {risk.product_id or 'unknown'}",
            ...
            if result.status in _ANOMALY_TO_SEVERITY:
                findings.append(
                    AIFinding(
                        ...
                        title=f"Sales anomaly for product {entry.product_id}",
                        description=(
